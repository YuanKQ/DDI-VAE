...
def load_dataset_split(path, n_labeled, sample_size=3, valid_test_ratio=50):
    ...
    if n_labeled >= train_count: raise ("The value of n_labeled is lager than the size of train data set.")
...
def load_dataset(path, sample_size=3, valid_test_ratio=50):
    decrease_feature_matrix = []
    decrease_labs = []
    increase_feature_matrix = []
    increase_labs = []
...
#     x_label, y_label, x_unlabel, y_unlabel, valid_x, valid_y, test_x, test_y = load_dataset("/home/yuan/Code/PycharmProjects/vae/ddi/data", 5000)
#     print("end")